...
begin
  ...
  begin
    MessageDlg('Quilometragem final não pode ser inferior a inícial!',mtConfirmation,[mbok],1);
    edtKmFinal.SetFocus;
    Exit;
  end;
  ...
  begin
    MessageDlg('Quilometragem inícial e final não podem ter o mesmo valor!',mtConfirmation,[mbok],1);
    edtKmInicial.SetFocus;
    Exit;
  end;
